...
.icons a,.edTb,.sepline,.switch,.tbri{background-image:url(image/editor/editor_boolbar.png)}
...
a.icoAttach {background-position:-613px 1px}
...
<!--<a href="javascript:;" class="icoAttach" id="icoAttach" onClick="createattach(event, 1);return false;" title="上传附件"></a>
-->
