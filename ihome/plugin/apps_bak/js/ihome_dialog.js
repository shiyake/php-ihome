...
function resetDialog(){
	...
	$(msg_box).css("top" , msgTop + "px");
	$(msg_box).css("left" , msgLeft + "px");
	$(msg_box).css("width" , msgWidth + "px");
	$(msg_box).css("height" , msgHeight + "px");

	//alert(fullheight+'_'+fullwidth+'_'+msgWidth+'_'+msgHeight+'_'+msgTop+'_'+msgLeft);
}
