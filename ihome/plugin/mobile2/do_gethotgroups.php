...
//$userid=96;
	...
	foreach($grouplist as $value){
		$result[] = array('tag_id'=>$value[tagid],'tag_title'=>$value[tagname],'tag_group'=>$value[groupname],
		'tag_member'=>$value[membernum],'tag_topic'=>$value[threadnum],'tag_reply'=>$value[postnum],
		'tag_pic'=>$_SCONFIG[siteallurl].$value[pic]);
	}
