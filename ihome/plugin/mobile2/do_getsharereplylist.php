...
*/
	...
	foreach($topiclist as $value){
		$result[] = array('share_authorpic'=>avatar($value[authorid],middle),'share_id'=>$value[cid],'share_type'=>$value[idtype],'share_typeid'=>$value[id],'share_userid'=>$value[authorid],'share_username'=>$_SN[$value[authorid]],'share_text'=>$value[message],'share_time'=>$value[dateline]);
	}
