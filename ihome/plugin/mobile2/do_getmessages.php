...
//$userid=3;	
	...
	//将公告中的图片进行绝对路径化。  start<img src=\"image\/face\/24.gif\" class=\"face\">
		...
		$result[] = array('msg_userid'=>$values[msgfromid],'msg_username'=>$_SN[$value[msgfromid]],'msg_user_pic'=>avatar($values[msgfromid],middle),'msg_id'=>$values[pmid],'msg_content'=>$values[message],'msg_time'=>$values[dateline]);
	}
