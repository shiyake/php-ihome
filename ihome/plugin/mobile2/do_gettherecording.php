...
*/
	...
	//$value[image_1] = $_SCONFIG[siteallurl].$value[image_1];
		$result = array('news_userid'=>$value[uid],'news_username'=>$_SN[$value[uid]],'news_userpic'=>avatar($value[uid],middle),'news_id'=>$value[doid],'news_text'=>$value[message],'news_time'=>$value[dateline],
