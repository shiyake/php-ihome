...
*/
	...
	foreach($pic as $album){
		...
		$result[] = array('pic_userpic'=>avatar($album['uid'],middle),'pic_username'=>$_SN[$album['uid']],'pic_userid'=>$album[uid],'pic_time'=>$album[dateline],'pic_note'=>$album[title],'pic_url'=>$album[filepath],'pic_name'=>$album[filename],'pic_albumid'=>$album[albumid],'pic_album'=>$album[albumname]);
	}
