jQuery.fn.rater	= function(options) {
	...
	var settings = {
		...
		after_ajax	: null,
		title_format	: null,
		image	: 'plugin/apps/images/star.gif',
		width	: 25,
		height	: 25
	}; 
	...
	for (var value=settings.min ; value<=settings.max ; value+=settings.step) {
		...
		if (typeof settings.title_format == 'function') {
			...
			switch(value){
				case 1:var startitle='很差';break;
				case 2:var startitle='不行';break;
				case 3:var startitle='可以';break;
				case 4:var startitle='很好';break;
				case 5:var startitle='十分完美';break;
			}
			item.attr('title' , startitle);
		}
		item.css('height' , settings.height);
