...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["source","cleardoc","undo","redo","unlink","link","gmap","map","music","insertvideo","emotion","date","time","|","pagebreak","horizontal","spechars","blockquote","insertcode","removeformat","formatmatch","autotypeset","bold","italic","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifyright","justifycenter","justifyjustify","paragraph","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"]]
