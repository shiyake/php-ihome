...
$_SGLOBAL['cplang'] = array(
	...
	'the_volumes_of_data_into_databases_success' => '分卷数据成功导入iHome数据库.',
	...
	'choose_to_delete_the_columns_tag' => '请至少正确选择一个要删除的小组',
	'designated_to_merge_the_columns_do_not_exist' => '要合并到的新小组还没有创建，请先自行创建此小组后再进行合并',
	'the_successful_merger_of_the_designated_columns' => '合并指定的小组成功了',
	'columns_option_to_merge_the_tag' => '请至少正确选择一个要合并的小组',
	'lock_open_designated_columns_tag_success' => '锁定/开放指定的小组成功了',
	'recommend_designated_columns_tag_success' => '推荐/取消推荐指定的小组成功了',
	'choose_to_operate_columns_tag' => '请至少正确选择一个要操作的小组',
	...
	'there_is_no_designated_users_columns' => '指定操作的小组栏目不存在',
	'choose_to_delete_the_columns' => '请正确选择要删除的栏目',
	'have_one_mtag' => '删除失败，请至少要保留一个小组栏目',
