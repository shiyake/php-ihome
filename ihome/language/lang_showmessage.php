...
$_SGLOBAL['msglang'] = array(
	...
	'box_title' => '消息',
    //do_register
    'no_such_username' => '对不起，没有这个用户名',
    'no_such_collegeid' => '对不起，没有这个学号/职工号',
	//common
	'birthday_is_null' => '对不起，生日输入有误！',
	'birthday_is_not_legitimate' => '对不起，输入不能为空！',
	'do_success' => '进行的操作完成了',
	...
	//mt.php
	'designated_election_it_does_not_exist' => '指定的小组不存在，您可以尝试创建',
	'mtag_tagname_error' => '设置的小组名称不符合要求',
	'mtag_join_error' => '加入指定的小组失败，请尝试搜索现有的相关小组，并在相应的小组中申请成为会员',
	'mtag_join_field_error' => '小组分类 \\1 下面最多只允许加入 \\2 个小组，您已经到达上限',
	'mtag_creat_error' => '您要查看的小组目前还没有被创建',
	...
	'collegeid_is_wrong' => '学号输入存在错误，请重新输入！',
	'identifier_uncertain' => '无法确定您的身份，请您与系统管理员联系！热线电话：+86 010-82317005',
	'identifier_is_active' => '您已经注册，请直接登录',
	'collegeid_is_not_legitimate' => '学号（职工号）不合法，请重新输入',
	'collegeid_is_null' => '您输入的学号（职工号）有误，请重新输入。',
	'collegeid_is_invalid' => '对不起，没有这个学号（职工号）！',
	'collegeid_is_active' => '此学号（职工号）已激活！',
	'collegeid_invalid' => '您输入的学号（职工号）无效，请重新输入！',
	'collegeid_not_active' => '激活邮件已发往您的系统邮箱<br /><br /><br /><a href="http://mail.buaa.edu.cn/" target="_blank" style="color:blue">进入学校邮箱</a><br /><br /><br /><a href="help.php?ac=activate" target="_blank" style="color:red;">查看激活帮助</a>',
	'have_no_email' => '对不起，该学号的北航邮箱无效，请与系统管理员联系！',
	'email_not_exist' => '对不起，该学号不存在北航邮箱，请与系统管理员联系！',
	'mail_not_adequent' => '对不起，您的北航邮箱空间不足，请在激活前清理邮箱！',
	'sendtime_limit' => '邮件已发送，请查收学校邮箱!',
	'telephone_already_exists' => '已经存在一个手机号：',

	'upload_success' => '文件已成功上传并保存',
	'upload_have_problem' => '文件存在部分问题，请根据链接地址下载后更新重新提交',
	'upload_failure' => '文件上传失败，请检查后重新上传',
	'file_limit' => '只允许小于100MB的xls格式的文件才能上传！',
	'no_file_upload' => '没有上传文件，请选择需要上传的文件',

	'realname_is_null' => '姓名输入有误，请重新输入！',
	'both_is_null' => '邮件或手机号至少须有一种联系方式！',
	//source/do_buaaregister.php
	'activateemail_receive' => '亲爱的朋友，您已经成功激活，尽情享受ihome带给您的惊喜吧！',
	'collegeid_invalid' => '此激活链接无效，请先进入首页激活！',
	'non_userinfo' => '激活无效，请先进入首页激活！',
	'email_timeout' => '激活邮件已经过期，请重新激活！',
	'users_have_actived' => '该用户账号已激活，请直接登录！',

	//source/do_quickregister.php
	'verify_fail' => '学号/职工号验证失败，请确认您的学号与一卡通密码是否正确!',
	'collegepassword_is_null' => '一卡通密码不能为空，请输入密码！',

	//source/do_mobileregister.php With do_mobileregajax.php
	'realnameWITHbirthday_is_invalid' =>'请确认您是新生，再核实您输入的姓名与生日是否正确！',


	//source/cp_invite2.php
	'mobile_is_wrong' => '此手机号已经存在',
	'all_is_right' => '数据正确，已经存储',
	'email_mobile_is_wrong' => '您指定的邮箱或者手机号已经存在，请重新输入！',
	'mobile_send' => '邀请信息已发送到手机，感谢您的邀请！',
	'email_and_mobile_send' => '邀请信息已经成功发送到邮箱与手机，感谢您的邀请！',
	'email_send' => '邀请信息已经成功发送到邮箱，感谢您的邀请！',
	...
	'video_is_illegality' => '视频规格不对',
	'this_video_noreply' => '该视频不接受评论',

	//source/cp_common.php
	'security_exit' => '你已经安全退出了\\1',

	//source/cp_doing.php
	'should_write_that' => '至少说点神马吧...',
	...
	'public_add' => '您已成功关注本公共主页',//Lv
	'public_have' => '您已关注本公共主页',
	'public_not_have' => '您尚未关注本公共主页',

	//source/cp_mtag.php
	'mtag_managemember_no_privilege' => '您不能对当前选定的成员进行小组权限变更操作，请重新选择',
	'mtag_max_inputnum' => '无法加入，您在栏目 "\\1" 中的小组数目已达到 \\2 个限制数目',
	'you_are_already_a_member' => '您已经是该小组的成员了',
	'join_success' => '加入成功，您现在是该小组的成员了',
	'the_discussion_topic_does_not_exist' => '对不起，参与讨论的话题不存在',
	'content_is_not_less_than_four_characters' => '对不起，内容不能少于2个字符',
	'you_are_not_a_member_of' => '您不是该小组的成员',
	'unable_to_manage_self' => '您不能对自己进行操作',
	'mtag_joinperm_1' => '您已经选择加入该小组，请等待群主审核您的加入申请',
	'mtag_joinperm_2' => '本小组需要收到群主邀请后才能加入',
	'invite_mtag_ok' => '成功加入该小组，您可以：<a href="space.php?do=mtag&tagid=\\1" target="_blank">立即访问该小组</a>',
	'invite_mtag_cancel' => '忽略该小组邀请完成',
	'failure_to_withdraw_from_group' => '退出私密小组失败,请先指定一个主群主',
	...
	'above_the_maxchoice' => '超过了最多选项，请重新选择',
	'below_the_minchoice' => '少于最低投票选项，请多选择几项，谢谢！',

	//source/cp_share.php
	'have_shared' => '您已分享过这条信息',
	...
	'video_does_not_exist' => '指定的视频不存在',
	'image_can_not_share' => '指定的图片因隐私设置不能够被分享',
	'video_can_not_share' => '指定的视频因隐私设置不能够被转发',
	'topics_does_not_exist' => '指定的话题不存在',
	'mtag_fieldid_does_not_exist' => '指定的小组分类不存在',
	...
	'email_is_wrong' => '您指定的邮箱已经存在，请重新输入！',
	...
	'no_file' => '没有文件！',
	'post_video_OK' => '上传视频OK！',
 	'file_too_large' => '图片上传失败，请选择小于2M图片',
	//source/cp_thread.php
	'to_login' => '您需要先登录才能继续本操作',
	'title_not_too_little' => '标题不能少于2个汉字(或4个字符)',
	'posting_does_not_exist' => '指定的话题不存在',
	'settings_of_your_mtag' => '有了小组才能发话题，你需要先设置一下你的小组。<br>通过小组，您可以结识与你有相同选择的朋友，更可以一起交流话题。<br><br><a href="cp.php?ac=mtag" class="submit">设置我的小组</a>',
	'first_select_a_mtag' => '你至少应该选择一个小组才能发话题。<br><br><a href="cp.php?ac=mtag" class="submit">设置我的小组</a>',
	'no_mtag_allow_thread' => '当前你参与的小组加入人数不足，还不能进行发话题操作。<br><br><a href="cp.php?ac=mtag" class="submit">设置我的小组</a>',
	'mtag_close' => '选择的小组已经被锁定，不能进行本操作',

	//source/space_album.php
	'to_view_the_photo_does_not_exist' => '出问题了，您要查看的相册不存在',

	//source/space_blog.php	 //source/space_arrangement.php
	...
	'system_error' => '系统错误，未找到Client文件，请与系统管理员联系',
	'password_inconsistency' => '两次输入的密码不一致',
	'profile_passwd_illegal' => '密码空或包含非法字符，请重新填写。',
	'user_name_is_not_legitimate' => '用户名不合法，请确保您的用户名大于3个字符',
	...
	'register_error' => '注册失败',
	'apply_public_username_already_existed' => '待审批的公共主页申请中已存在该用户名',
	'apply_public_name_already_existed' => '待审批的公共主页申请中已存在该名称',
	'apply_public_email_already_existed' => '待审批的公共主页申请中已存在该EMAIL',
	...
	'mtag_minnum_erro' => '本小组成员数不足 \\1 个，还不能进行本操作',
	...
	'mtag_not_allow_to_do' => '您不是该话题所在小组的成员，没有权限进行本操作',
	...
	'event_mtag_not_match' => '指定小组没有关联到本活动',
	...
	//public_apply.php By Lv
	'apply_s' => '您的申请已发出，管理员会及时处理，请等待，注意查收邮件',
	'apply_not_by_publicpage' => '公共主页只能使用个人账号进行申请',
	'apply_illegal' => '申请未按格式要求填写',
	'username_less' => '用户名少于3个字符',
	'username_more' => '用户名超过15个字符',
	'fullname_less' => '公共主页名称少于2个文字',
	'fullname_more' => '公共主页名称超过20个文字',
	'fullname_exist' => '已存在此公共主页',
	'fullname_illegal' => '公共主页名称不合法',


	//足迹墙提示 xuxing@ihome 2012-9-27
	'wall_not_exist' => '该足迹墙不存在',
	'do_failed' => '操作失败',
	'wall_desc_illegal' => '描述不符合要求',
	'wall_title_illegal' => '标题不符合要求',
	'wall_time_illegal' => '开始或结束时间必须按格式填写',
	'wall_time_reverse' => '结束时间必须大于开始时间',
	'wall_endtime_early' => '结束时间必须大于当前时间',
	'wall_uid_illegal' => '审核人uid不正确',
	'wall_not_privillege' => '非公共主页不允许申请',

    //密保
    'protect_info_not_enough' => '密保问题没有填全',
    'protect_question_update_success' => '密保问题设置成功',
    'protect_info_not_correct' => '密保答案不正确',
    'send_too_quick' => '短信发送的太快',
    'send_ok' => '短信发送成功',
    'mobile_not_right' => '不是手机号码',
    'mobile_code_not_right' => '手机验证码不对',
    'protect_mobile_update_success' => '密保手机设置成功',
    'mobile_num_not_change' => '发送验证码的不是这个手机',
    'email_not_same' => '邮箱不一样',
    'email_not_right' => '邮箱不对',
    'email_code_not_right' => '邮箱验证码不对',
