...
$acs = array(
	...
	array('tag', 'mtag', 'event', 'report', 'space', 'userimport', 'job'),
	array('cache', 'network', 'profilefield', 'eventclass', 'click', 'task', 'censor', 'stat', 'block', 'cron', 'app', 'log','wallmanage','publicapply','publictype','recommendpublic','complain','apps','loginbg','ad4app','map','overseas','asst', 'calenderCheck'),
