...
$acs = array(
	...
	array('cache', 'network', 'profilefield', 'eventclass', 'click', 'task', 'censor', 'stat', 'block', 'cron', 'app', 'log','wallmanage','publicapply','publictype','recommendpublic','complain','apps','loginbg','map','overseas','asst'),
