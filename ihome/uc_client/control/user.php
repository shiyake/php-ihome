...
class usercontrol extends base {
	 ...
	 * -3 û���ϴ�ͷ��
	 */
	//note public �ⲿ�ӿ� flash �ϴ�ͷ��
	function onuploadavatar() {
	}

	//note public �ⲿ�ӿ� flash ��ʽ�ü�ͷ�� COOKIE �ж����
