...
function seccode() {
	...
	document.writeln('<img height="35px" id="img_seccode" src="'+img+'" align="absmiddle">');
}
...
//激活页面验证码
function activeseccode(num) {
	var img = 'do.php?ac=seccode&rand='+Math.random();
	document.writeln('<img height="35px" id="img_seccode_'+num+'" src="'+img+'" align="absmiddle">');
}
function activeupdateseccode(num) {
	var img = 'do.php?ac=seccode&rand='+Math.random();
	if($('img_seccode_'+num)) {
		$('img_seccode_'+num).src = img;
	}
}
...
function showFlash(host, flashvar, obj, shareid) {
	...
	var flash = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="440" height="420">'
	    + '<param name="movie" value="FLASHADDR" />'
	    + '<param name="quality" value="high" />'
	    + '<param name="bgcolor" value="#FFFFFF" />'
	    + '<embed width="440" height="420" menu="false" quality="high" src="FLASHADDR" type="application/x-shockwave-flash" />'
	    + '</object>';
	var videoFlash = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="440" height="420">'
        + '<param value="transparent" name="wmode"/>'
		+ '<param value="FLASHADDR" name="movie" />'
		+ '<embed src="FLASHADDR" wmode="transparent" allowfullscreen="true" type="application/x-shockwave-flash" width="440" height="420"></embed>'
		+ '</object>';
