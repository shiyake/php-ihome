...
$query = $_SGLOBAL['db']->query("select xaxis_tag, value from ".tname("columntable")." where chart_tag='activate_analyse' and xaxis_tag >= '$start_date' and xaxis_tag <= '$end_date'");
$items = array();
