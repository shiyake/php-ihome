<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/new/cp_pm|template/new/header|template/new/footer', '1381915158', 'template/new/cp_pm');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
<!DOCTYPE>
<html>
<head>
