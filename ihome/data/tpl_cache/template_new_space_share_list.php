...
<ul class="tabs">
<?php if($space['friendnum']) { ?><li<?=$actives['we']?>><a href="space.php?uid=<?=$space['uid']?>&do=share"><span>好友的分享</span></a></li><?php } ?>
...
<a href="<?=$theurl?>&type=mtag"<?=$sub_actives['type_mtag']?>>小组</a><span class="pipe">|</span>
