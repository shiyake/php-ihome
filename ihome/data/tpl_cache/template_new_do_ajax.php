<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/new/do_ajax|template/new/header|template/new/space_comment_li|template/new/space_post_li|template/new/space_share_li|template/new/footer', '1381748474', 'template/new/do_ajax');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
<!DOCTYPE>
<html>
<head>
