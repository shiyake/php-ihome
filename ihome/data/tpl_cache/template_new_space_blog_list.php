<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/new/space_blog_list|template/new/header|template/new/space_menu|template/new/footer', '1381829383', 'template/new/space_blog_list');?><?php $_TPL['titles'] = array('日志'); ?>
...
<li<?=$actives['freshman']?>><a href="space.php?uid=<?=$space['uid']?>&do=<?=$do?>&view=freshman"><span>新生须知</span></a></li>
...
<div class="gray">
<?php if($classarr[$value['classid']]) { ?>日志分类: <a href="space.php?uid=<?=$value['uid']?>&do=blog&classid=<?=$value['classid']?>"><?=$classarr[$value['classid']]?></a><span class="pipe">|</span><?php } ?>
