<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/new/showmessage|template/new/header|template/new/footer', '1382769064', 'template/new/showmessage');?><?php $_TPL['nosidebar']=1; ?>
