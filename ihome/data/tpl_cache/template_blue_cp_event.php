<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/blue/cp_event|template/blue/header|template/blue/cp_topic_menu|template/blue/footer|template/blue/space_topic_inc', '1381731216', 'template/blue/cp_event');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
<!DOCTYPE>
<html>
<head>
