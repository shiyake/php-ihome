<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/new/space_mtag|template/new/header|template/new/footer', '1382425526', 'template/new/space_mtag');?><?php $_TPL['titles'] = array('小组'); ?>
...
<input name="searchsubmit" value="搜索小组" class="submit" type="submit">
<input type="hidden" name="searchmode" value="1" />
<input type="hidden" name="do" value="mtag" />
<input type="hidden" name="view" value="hot" />
</form>
</div>
<h2 class="title"><img src="image/app/mtag.gif">小组</h2>
<div class="tabs_header">
<ul class="tabs">
<li><a href="space.php?uid=<?=$space['uid']?>&do=thread"><span>小组话题</span></a></li>
<li<?=$actives['me']?>><a href="space.php?do=mtag&view=me"><span>我参与的小组</span></a></li>
<li<?=$actives['manage']?>><a href="space.php?do=mtag&view=manage"><span>我管理的小组</span></a></li>
<li<?=$actives['hot']?>><a href="space.php?do=mtag&view=hot"><span>热门小组</span></a></li>
<li<?=$actives['recommend']?>><a href="space.php?do=mtag&view=recommend"><span>推荐小组</span></a></li>
<li class="null"><a href="cp.php?ac=thread">发起新话题</a></li>
<li class="null"><a href="cp.php?ac=mtag">创建小组</a></li>
</ul>
</div>
...
<?php if($searchkey) { ?>
<div class="h_status">以下是搜索小组 <span style="color:red;font-weight:bold;"><?=$searchkey?></span> 结果列表</div>
<?php } ?>
