<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/blue/cp_advance|template/blue/header|template/blue/cp_header|template/blue/footer', '1381194590', 'template/blue/cp_advance');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
<!DOCTYPE>
<html>
<head>
