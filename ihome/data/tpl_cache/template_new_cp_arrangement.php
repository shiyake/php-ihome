<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/new/cp_arrangement|template/new/header|template/new/footer', '1381737578', 'template/new/cp_arrangement');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
<!DOCTYPE>
<html>
<head>
