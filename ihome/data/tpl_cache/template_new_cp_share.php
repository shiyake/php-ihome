<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/new/cp_share|template/new/header|template/new/cp_topic_menu|template/new/space_share_li|template/new/footer|template/new/space_topic_inc', '1382328213', 'template/new/cp_share');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
<!DOCTYPE>
<html>
<head>
