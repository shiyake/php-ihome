<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/new/space_album_list|template/new/header|template/new/space_menu|template/new/footer', '1381829386', 'template/new/space_album_list');?><?php $_TPL['titles'] = array('相册'); ?>
