<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/blue/cp_profile|template/blue/header|template/blue/cp_header|template/blue/footer', '1381194586', 'template/blue/cp_profile');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
<!DOCTYPE>
<html>
<head>
