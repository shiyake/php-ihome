<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('admin/tpl/index|admin/tpl/header|admin/tpl/side|admin/tpl/footer|template/blue/header|template/blue/footer', '1381194597', 'admin/tpl/index');?><?php $_TPL['menunames'] = array(
		'index' => '管理首页',
		'config' => '站点设置',
		'privacy' => '隐私设置',
		'usergroup' => '用户组',
...
<li>当前程序版本: BUAA iHome <?=$statistics['version']?> ( <?=$statistics['release']?> )</li>
</ul>
</div>
<br />
...
<table>
<tr><td width="80"></td><td>i 北航社区建设团队</td></tr>
<tr><td>总策划</td><td>Wqq, Lych</a></td></tr>
<tr><td>开发团队</td><td>Seen, Ancon, Avaziyi, Lv, Martin, jiangtao</td></tr>
<tr><td>美工设计</td><td>WangYongchao, JiangShan</td></tr>
<tr><td>推广营销</td><td>Baggio</td></tr>
<tr><td>信息管理</td><td>娇娇</td></tr>
</table>
</div>
<?php } else { ?>
<div class="bdrcontent">
...
<?php if($WallStartFlag) { ?><li><a href="admincp.php?ac=wallcontentmanage" style="font-weight:bold;">足迹墙</a><p>对上墙的内容进行审核管理</p></li><?php } ?>
...
<?php if($_SGLOBAL['usergroup'][$m_groupid]['allowstat']) { ?><li><a href="do.php?ac=stat" style="font-weight:bold;">统计图</a><p>对站点的各种统计数据进行查看</p></li><?php } ?>
