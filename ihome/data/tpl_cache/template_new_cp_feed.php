<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/new/cp_feed|template/new/header|template/new/space_comment_li|template/new/space_feed_li|template/new/footer', '1381906239', 'template/new/cp_feed');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
<!DOCTYPE>
<html>
<head>
