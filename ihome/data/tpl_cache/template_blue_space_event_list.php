<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/blue/space_event_list|template/blue/header|template/blue/space_menu|template/blue/footer', '1381731215', 'template/blue/space_event_list');?><?php $_TPL['titles'] = array('活动'); ?>
