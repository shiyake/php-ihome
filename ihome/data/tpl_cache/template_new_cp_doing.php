<?php if(!defined('iBUAA')) exit('Access Denied');?><?php subtplcheck('template/new/cp_doing|template/new/header|template/new/space_doing_li|template/new/space_doing_form|template/new/footer', '1381915186', 'template/new/cp_doing');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
<!DOCTYPE>
<html>
<head>
...
<input type="text" id="do_message_<?=$doid?>_<?=$id?>" name="message" size="35" class="t_input" onkeydown="return ctrlEnter(event, 'docommform_btn_<?=$doid?>_<?=$id?>', 1);" onfocus="at()">
